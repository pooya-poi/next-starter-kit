    ...
    >
      ...
      >
        ...
        <m.path
          ...
          animate={controls}
        />
        <m.path d="M4 3h.01" variants={dotsVariants} animate={controls} />
        <m.path d="M22 8h.01" variants={dotsVariants} animate={controls} />
        <m.path d="M15 2h.01" variants={dotsVariants} animate={controls} />
        <m.path d="M22 20h.01" variants={dotsVariants} animate={controls} />
        <m.path
